	...
	<div class="container">
		...
		<div id="maincontent" >
			<form action="thank-you.html" method="post" id="myform"> 
				...
				<div class="form-group required-field" style="width: 250px;">
					<input type="input" class="form-control" id="id" placeholder="ID Number">
				</div>
				
				<div class="form-group required-field" style="width: 250px;">
					<input type="input" class="form-control date" id="dob" placeholder="Date of birth"> 
				</div>	
				...
				<div class="form-group required-field" style="width: 250px;">	
  				...
  				<div class="form-group">
					<input name="Submit" type="submit" value="Submit" class="btn btn-primary submit" />
				</div>
